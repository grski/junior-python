...
3. [CS50](https://pll.harvard.edu/course/cs50-introduction-computer-science?delta=0) - chyba najlepszy kurs z podstaw Informatyki. Równolegle do tej książki oraz Learning Python.
4. Effective Python, 2nd edition - Brett Slakin <- Świetna książka do przerobienia po tym, jak przeczytasz obecną pozycję oraz Learning Python to zajrzyj tutaj. Podszlifujesz swojego Pythona całkiem znacząco.
5. Fluent Python - Luciano Ramalho <- Książka podobna do Effective Python. Opcjonalnie.
6. Designing Data Intensive Applications - Martin Kleppman  <- Jak już skończysz tę książkę, cs50, Learning Python (część) oraz Effective Python, to fajnie rozszerzyć horyzonty i zajrzeć właśnie tutaj. Świetna książka o projektowaniu nie tyle samego kodu co i całego systemu wręcz.
7. Understanding Software - Max Kanat-Alexander <- Kolejna rzecz do przeczytania.
8. [Zalando API Guidelines](https://opensource.zalando.com/restful-api-guidelines/) <- przejrzyj chociaż pobieżnie
